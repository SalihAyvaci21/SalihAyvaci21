<div align="center">
  <img src="https://capsule-render.vercel.app/api?type=waving&color=00ff88&height=200&section=header&text=Salih%20Tekin%20Ayvacı&fontSize=50&fontColor=121212&animation=fadeIn&fontAlignY=35" width="100%" />
</div>
...
Merhaba! Ben **Salih**. Elektronik donanımların sınırlarını zorlamayı, **FPGA** ile lojik devreler tasarlamayı ve kendi **PCB**'lerimi üretmeyi seviyorum. 

- 🔭 Şu an **Gatemate & Gowin FPGA** mimarileri ve **SDR (Software Defined Radio)** üzerine çalışıyorum.
- 🚁 **Drone Teknolojileri** ve **Motor Sürücü (ESC)** tasarımları özel ilgi alanım.
- 🌱 **Verilog** ve **Gömülü C++** yeteneklerimi geliştiriyorum.
- ⚡ **Hobim:** Don't Starve Together için Lua modları yazmak ve Retro oyunlar geliştirmek.
